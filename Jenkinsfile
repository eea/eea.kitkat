pipeline {
  ...
  environment {
        GIT_NAME = "eea.kitkat"
        SONARQUBE_TAGS = "www.eea.europa.eu,www.eea.europa.eu-en,demo-www.eea.europa.eu,climate-advisory-board.europa.eu,forest.eea.europa.eu,biodiversity.europa.eu,insitu.copernicus.eu,land.copernicus.eu"
    }
